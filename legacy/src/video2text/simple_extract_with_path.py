#!/usr/bin/env python3
"""
Simple Video to Text Extraction with custom FFmpeg path
...
# Custom FFmpeg path
FFMPEG_PATH = r"D:\Coding\program4kids\ffmpeg\ffmpeg-8.0-essentials_build\bin\ffmpeg.exe"
...
def extract_audio_simple(video_path: str, output_path: str = None) -> str:
    ...
    try:
        ...
        print("Please check the FFmpeg installation path.")
        raise
...
def main():
    ...
    if not check_ffmpeg():
        ...
        print("Please check the FFmpeg installation.")
        return
