...
class SlideDeck {
    ...
    renderControls() {
        ...
        prevBtn.innerHTML = `<svg width="32" height="32" viewBox="0 0 24 24" fill="#8b5cf6"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>`;
        prevBtn.className = 'nav-btn';
        prevBtn.onclick = () => this.prev();
        const nextBtn = document.createElement('button');
        nextBtn.innerHTML = `<svg width="32" height="32" viewBox="0 0 24 24" fill="#8b5cf6"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>`;
