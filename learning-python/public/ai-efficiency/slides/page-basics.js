            ...
            content: `
                <div style="display: flex; gap: 20px; text-align: left;">
                    <div style="flex: 1; min-width: 0;">
                        ...
                        <pre style="background: #f1f5f9; padding: 15px; border-radius: 8px; font-family: monospace; font-size: 0.9rem; overflow-x: auto; border: 1px solid #e2e8f0; white-space: pre-wrap; color: #334155;">
# 大语言模型(LLM)简介
...
<pre style="margin: 0; font-family: 'Consolas', 'Monaco', monospace; line-height: 1.5; color: #d4d4d4;">
            ...
            content: `
                ...
                <div style="display: flex; gap: 20px; text-align: left;">
                    <div style="flex: 1; min-width: 0; background: #1e1e1e; padding: 20px; border-radius: 8px; border-top: 4px solid #3776ab; box-shadow: inset 0 2px 4px rgba(0,0,0,0.5);">
                        ...
                        <pre style="color: #d4d4d4; font-family: monospace; font-size: 1rem; margin:0; white-space: pre-wrap;"><span style="color: #c586c0;">def</span> <span style="color: #dcdcaa;">greet_ai</span>(name):
...
<span style="color: #4ec9b0;">print</span>(greet_ai(<span style="color: #ce9178;">"Commander"</span>))</pre>
                    ...
                    <div style="flex: 1; min-width: 0; background: #1e1e1e; padding: 20px; border-radius: 8px; border-top: 4px solid #f7df1e; box-shadow: inset 0 2px 4px rgba(0,0,0,0.5);">
                        ...
                        <pre style="color: #d4d4d4; font-family: monospace; font-size: 1rem; margin:0; white-space: pre-wrap;"><span style="color: #569cd6;">const</span> <span style="color: #dcdcaa;">greetAI</span> = (name) <span style="color: #569cd6;">=></span> {
        ...
        git: {
            ...
            content: `
                <div style="text-align: center; padding: 40px;">
                    ...
                    <p style="color: #64748b; font-family: monospace; font-size: 1.2rem; background: #f1f5f9; display: inline-block; padding: 8px 16px; border-radius: 6px; border: 1px solid #e2e8f0;">> git commit -m 'Initial commit'</p>
                </div>
            `
        }
    };
